...
CREATE DEFINER=`root`@`localhost` PROCEDURE `stafflapangan_project_selpro` (IN `idu` INT(50))  SELECT * FROM stafflapangan_project_selpro1
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `stafflapangan_project_tsp` (IN `iduser` INT(50))  SELECT * FROM stafflapangan_project_tsp1
WHERE id_user = iduser AND status = 'sedang_berjalan'$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `store_dokumen_tambahan` (IN `idlaporan` VARCHAR(15), IN `idproject` INT(10), IN `iduser` INT(10), IN `idtype` VARCHAR(5), IN `dokumen1` VARCHAR(255))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `store_laporan_akhir` (IN `idlaporan` VARCHAR(15), IN `idproject` INT(10), IN `iduser` INT(10), IN `idtype` VARCHAR(5), IN `dokumen1` VARCHAR(255))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `store_laporan_harian` (IN `project_id` VARCHAR(3), IN `user_id` VARCHAR(3))  BEGIN
	INSERT INTO laporan_project(id_laporan, id_project, id_user, id_type, waktu_dibuat, waktu_dikirim, waktu_dikonfirmasi , status)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `store_laporan_progress` (IN `idlaporan` VARCHAR(15), IN `idproject` INT(10), IN `iduser` INT(10), IN `idtype` VARCHAR(5), IN `dokumen1` VARCHAR(255))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `store_laporan_rab` (IN `idlaporan` VARCHAR(15), IN `idproject` INT(10), IN `iduser` INT(10), IN `idtype` VARCHAR(5), IN `dokumen1` VARCHAR(255))  BEGIN
...
(1, 'nikodema01@gmail.com', 'Budiman', '0812313451541', '2023-01-11 06:39:59', NULL);
...
(1, 'selesai', '2022-12-31 17:25:26', '2023-01-08 16:43:35'),
(2, 'sedang_berjalan', '2023-01-08 23:20:36', NULL),
(3, 'selesai', '2023-01-08 23:24:51', '2023-01-11 07:15:49'),
(4, 'selesai', '2023-01-08 23:26:28', '2023-01-11 08:00:12'),
(5, 'sedang_berjalan', '2023-01-08 23:28:36', NULL),
(6, 'sedang_berjalan', '2023-01-11 13:44:50', NULL);
...
(48, 'Linda Lauw', 'staff5@gmail.com', NULL, '$2y$10$VqC9NquMGGmMeImdKNlkSuExikOku1vKenTDIX/dzyitK2biddIXy', 'Staff', NULL, '2023-01-08 10:16:33', '2023-01-08 10:16:33'),
...
--
ALTER TABLE `negosiasi`
  MODIFY `id_negosiasi` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
